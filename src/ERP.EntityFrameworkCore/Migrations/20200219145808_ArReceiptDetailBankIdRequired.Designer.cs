...
namespace ERP.Migrations
{
    ...
    [Migration("20200219145808_ArReceiptDetailBankIdRequired")]
    partial class ArReceiptDetailBankIdRequired
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP._System.__AccountModule._ArReceipts.ArReceiptDetails", b =>
                {
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "FndBankLkp")
                        .WithMany("ArReceiptDetailBankLkpCollection")
                        .HasForeignKey("BankLkpId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ERP._System.__AccountModule._ArReceipts.ArReceipts", b =>
                {
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "FndArCustomerLkp")
                        .WithMany("ArReceiptArCustomerLkpCollection")
                        .HasForeignKey("ArCustomerId");

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "FndBankAccountLkp")
                        .WithMany("ArReceiptBankAccountLkpCollection")
                        .HasForeignKey("BankAccountId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "FndCurrencyLkp")
                        .WithMany("ArReceiptCurrencyLkpCollection")
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "FndRemitanceBankLkp")
                        .WithMany("ArReceiptRemitanceBankLkpCollection")
