...
namespace ERP.Migrations
{
    ...
    [Migration("20200301113751_PmOwners_BankAndCashIds_NotCodeComs_ItIsBankAccount_WithRequired")]
    partial class PmOwners_BankAndCashIds_NotCodeComs_ItIsBankAccount_WithRequired
    {
            ...
            modelBuilder.Entity("ERP._System.__PmPropertiesModule._PmOwners.PmOwners", b =>
                {
                    ...
                    b.HasOne("ERP._System._ApBankAccounts.ApBankAccounts", "GlCodeComBankAccount")
                        .WithMany()
                        .HasForeignKey("BankAccountId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ERP._System._ApBankAccounts.ApBankAccounts", "GlCodeComCashAccount")
                        .WithMany()
