...
namespace ERP.Migrations
{
    ...
    [Migration("20200126100919_add-tbl-FndUsers-FndUsersRelatives")]
    partial class addtblFndUsersFndUsersRelatives
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP._System.__AidModule._FndUserRelatives.FndUserRelatives", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("FndUserRelatives");
                });

            modelBuilder.Entity("ERP._System.__AidModule._FndUsers.FndUsers", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("IdNumberWife1")
                        .HasMaxLength(15);
            ...
            modelBuilder.Entity("ERP._System.__AidModule._FndUsers.FndUsers", b =>
                {
                    ...
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "GenderFndLookupValues")
                        .WithMany("GenderFndLookupValuesCollection")
                        .HasForeignKey("GenderLkpId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "MaritalStatusFndLookupValues")
                        .WithMany("MaritalStatusFndLookupValuesCollection")
                    ...
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "QualificationFndLookupValues")
                        .WithMany("QualificationFndLookupValuesCollection")
                        .HasForeignKey("QualificationLkpId");
                });
