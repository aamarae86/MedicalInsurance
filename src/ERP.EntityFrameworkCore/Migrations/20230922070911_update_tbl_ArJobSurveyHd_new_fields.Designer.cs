...
namespace ERP.Migrations
{
    ...
    [Migration("20230922070911_update_tbl_ArJobSurveyHd_new_fields")]
    partial class update_tbl_ArJobSurveyHd_new_fields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP._System.__AccountModule._ArJobSurveyHd.ArJobSurveyHd", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("ArJobSurveyStatusLkpId");
                    ...
                    b.Property<bool>("InsuredVehicle");
                    ...
                    b.HasIndex("ArJobSurveyStatusLkpId");
                    ...
                    b.ToTable("ArJobSurveyHd");
                });

            modelBuilder.Entity("ERP._System.__AccountModule._ArJobSurveyPartsList.ArJobSurveyPartsList", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("PartsCategoryLkpId");
                    ...
                    b.HasIndex("PartsCategoryLkpId");

                    b.ToTable("ArJobSurveyPartsList");
                });

            modelBuilder.Entity("ERP._System.__AccountModule._ArJobSurveyTr.ArJobSurveyTr", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<long?>("ArJobSurveyHdId");

                    b.Property<long?>("ArJobSurveyPartsId");
                    ...
                    b.HasIndex("ArJobSurveyHdId");

                    b.HasIndex("ArJobSurveyPartsId");

                    b.HasIndex("PartsCategoryLkpId");

                    b.ToTable("ArJobSurveyTr");
                });
            ...
            modelBuilder.Entity("ERP._System.__HR._HRPaperRequest.HrPaperRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("PaperReqDate");

                    b.Property<string>("PaperReqNumber");
                    ...
                    b.ToTable("HrPaperRequest");
                });

            modelBuilder.Entity("ERP._System.__HR._HRPaperRequest.HrPaperRequestAttachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long>("HrPaperRequestId");
                    ...
                    b.Property<long>("PaperReqTypeId");

                    b.Property<int>("TenantId");

                    b.HasKey("Id");

                    b.HasIndex("HrPaperRequestId");

                    b.HasIndex("HrPersonId");

                    b.HasIndex("PaperReqTypeId");

                    b.ToTable("HrPaperRequestAttachment");
                });

            modelBuilder.Entity("ERP._System.__HR._HRPaperRequest.PaperReqType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("PaperReqTypeName");
            ...
            modelBuilder.Entity("ERP._System.__HR._HrPersonTimeSheet.HrPersonTimeSheet", b =>
                {
                    ...
                    b.Property<long>("TimeSheetTypeId");
            ...
            modelBuilder.Entity("ERP._System.__HR._HrPersonTimeSheet.TimeSheetType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("TimeSheetTypeName");
            ...
            modelBuilder.Entity("ERP._System.__SalesModule._FndSalesMen.FndSalesMen", b =>
                {
                    ...
                    b.Property<int?>("DiscountPercentageAllowed");
            ...
            modelBuilder.Entity("ERP._System.__AccountModule._ArJobSurveyHd.ArJobSurveyHd", b =>
                {
                    ...
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "ArJobSurveyStatusLkp")
                        .WithMany()
                        .HasForeignKey("ArJobSurveyStatusLkpId");

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "JobTypeLkp")
                        .WithMany()
                        .HasForeignKey("JobTypeLkpId");

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "VehicleColorLkp")
                        .WithMany()
                        .HasForeignKey("VehicleColorLkpId");

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "VehicleEmirateLkp")
                        .WithMany()
                        .HasForeignKey("VehicleEmirateLkpId");

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "ArJobCardVehicleMakeLkp")
                        .WithMany()
                        .HasForeignKey("VehicleMakeLkpId");

                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "ArJobCardVehicleModelLkp")
                        .WithMany()
                        .HasForeignKey("VehicleModelLkpId");
                });
            ...
            modelBuilder.Entity("ERP._System.__AccountModule._ArJobSurveyPartsList.ArJobSurveyPartsList", b =>
                {
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "PartsCategoryLkp")
                        .WithMany()
                        .HasForeignKey("PartsCategoryLkpId");
                });

            modelBuilder.Entity("ERP._System.__AccountModule._ArJobSurveyTr.ArJobSurveyTr", b =>
                {
                    b.HasOne("ERP._System.__AccountModule._ArJobSurveyHd.ArJobSurveyHd", "ArJobSurveyHd")
                        .WithMany("ArJobSurveyTr")
                        .HasForeignKey("ArJobSurveyHdId");

                    b.HasOne("ERP._System.__AccountModule._ArJobSurveyPartsList.ArJobSurveyPartsList", "ArJobSurveyPartsList")
                        .WithMany()
                        .HasForeignKey("ArJobSurveyPartsId");
            ...
            modelBuilder.Entity("ERP._System.__HR._HRPaperRequest.HrPaperRequestAttachment", b =>
                {
                    b.HasOne("ERP._System.__HR._HRPaperRequest.HrPaperRequest", "HrPaperRequest")
                        .WithMany("HrPaperRequestAttachments")
                        .HasForeignKey("HrPaperRequestId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("ERP._System.__HR._HRPaperRequest.PaperReqType", "PaperReqType")
                        .WithMany()
                        .HasForeignKey("PaperReqTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ERP._System.__HR._HrPersonTimeSheet.HrPersonTimeSheet", b =>
                {
                    ...
                    b.HasOne("ERP._System.__HR._HrPersonTimeSheet.TimeSheetType", "TimeSheetType")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP._System.__SalesModule._IvSaleHd.IvSaleHd", b =>
                {
                    ...
                    b.HasOne("ERP._System._FndLookupValues.FndLookupValues", "FndLookupPaymentMethodLkp")
                        .WithMany()
                        .HasForeignKey("PaymentMethodLkpId");
