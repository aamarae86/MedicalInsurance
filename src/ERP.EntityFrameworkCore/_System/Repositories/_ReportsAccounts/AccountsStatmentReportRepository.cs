...
{
    public class AccountsStatmentReportRepository :
           ERPProcedureRepositoryBase<GlAccDetails, long, AccountsStatmentInput, AccountsStatmentOutput>, IAccountsStatmentReportRepository
    {
        public AccountsStatmentReportRepository(
