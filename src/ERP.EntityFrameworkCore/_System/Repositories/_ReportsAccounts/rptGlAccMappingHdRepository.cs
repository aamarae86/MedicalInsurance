...
{
    public class GetRptGlAccMappingHdRepository :
        ERPProcedureRepositoryBase<GlAccMappingHd, long, rptGlAccMappingHdInput, rptGlAccMappingHdOutput>, IGetRptGlAccMappingHdRepository
    {
        public GetRptGlAccMappingHdRepository(
