...
{
    public class ItemMovementReportRepository :
           ERPProcedureRepositoryBase<IvItems, long, ItemMovementInput, GetItemMovementDataOutput>, IItemMovementReportRepository
    {
        public ItemMovementReportRepository(
