...
{
    public class CrmLeadsPersonsController : BaseController
    {
        public CrmLeadsPersonsController() : base("CrmLeadsPersons", PermissionNames.Pages_CrmLeadsPersons_Insert)
        { }
        ...
        public PartialViewResult CrmLeadsPersonsSearch() => PartialView();

        public PartialViewResult CrmLeadsPersonsData() => PartialView();

        public PartialViewResult CrmLeadsPersonsForm(int? id, string trigger, CrmLeadsPersonsVM CrmLeadsPersonsVM)
        {
        ...
        public async Task<ActionResult> PostCrmLeadsPersons(CrmLeadsPersonsVM vm)
        {
            vm.TypeLkpId = 0;
            vm.AnnualRevenue=vm.AnnualRevenue ?? 0;
            if (vm.Id == 0)
            {
                vm.IsLead = 1;
